...
- Treat [provider-manager.ts](./services/provider-manager.ts) and [agent-runtime.ts](./services/agent-runtime.ts) as coordinator facades; extract collaborator services before adding more unrelated logic.
